...
def move_player(player: Player, key_depressed, movement_distance_x, movement_distance_y, asset_dict):
    ...
    if key_depressed == up:  # if up key is pressed
        ...
        if player.rect.x > 20:  # not at leftmost border
            ...
            left_image = pygame.transform.rotate(asset_dict.get_asset("frog"), 90)
            left_image2 = pygame.transform.rotate(asset_dict.get_asset("frog_jumping"), 90)
        ...
        if player.rect.x < 750:  # not at rightmost border
            x_change += movement_distance_x
            right_image = pygame.transform.rotate(asset_dict.get_asset("frog"), -90)
            right_image2 = pygame.transform.rotate(asset_dict.get_asset("frog_jumping"), -90)
        ...
        if player.rect.y < 800:  # not at bottom
            ...
            down_image = pygame.transform.rotate(asset_dict.get_asset("frog"), 180)
            down_image2 = pygame.transform.rotate(asset_dict.get_asset("frog_jumping"), 180)
